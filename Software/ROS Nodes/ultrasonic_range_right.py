...
# This node is to get the range from the right front ultrasonic distance sensor.
...
ultrasonicRangeRight = rospy.Publisher('ultrasonicRangeRight', String, queue_size=10)
rospy.init_node('ultrasonicRangeRight', anonymous=True)    
...
if __name__ == '__main__':
    try:
        while True:
            ...
            ultrasonicRangeRight.publish(str(actualDistance))
